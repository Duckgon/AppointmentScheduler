...
public class AddAppointmentController extends Application {
    ...
    public void initialize() throws SQLException {
        ...
        SpinnerValueFactory<Integer> starthour = new SpinnerValueFactory.IntegerSpinnerValueFactory(0,23);
        SpinnerValueFactory<Integer> startmin = new SpinnerValueFactory.IntegerSpinnerValueFactory(0,59);

        SpinnerValueFactory<Integer> endhour = new SpinnerValueFactory.IntegerSpinnerValueFactory(0,23);
